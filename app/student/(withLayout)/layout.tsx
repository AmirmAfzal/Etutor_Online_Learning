                ...
                {tabLinks.map((tab) => {
                  return (
                    <Link
                      ...
                      href={tab.href}
                      prefetch={false}
                      className="text-base-content/70 hover:text-primary rounded-md px-4 py-2.5 text-sm font-medium whitespace-nowrap transition-colors sm:px-5 sm:py-3 sm:text-base md:text-lg"
                    >
                      {tab.label}
                    </Link>
                  );
