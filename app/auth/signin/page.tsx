      ...
      <div className="col-span-3 flex flex-col items-center justify-center">
        ...
        <Form {...form}>
          ...
          >
              ...
              render={({ field }) => (
                <FormItem className="flex items-center space-x-2">
                  ...
                  <FormLabel htmlFor="terms" className="text-xs">
                    I Agree with all of your <a href="#" className="text-primary underline">Terms & Conditions</a>
                  </FormLabel>
                  <FormMessage />
                </FormItem>
              )}
            />
            {resultError && (
              <div className="text-red-600 text-sm text-center mb-2">{resultError}</div>
            )}
            <Button type="submit" className="w-full mt-2 text-base font-semibold bg-primary hover:bg-primary/90">
              Create Account
            </Button>
